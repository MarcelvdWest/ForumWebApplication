            ...
            if(session.getAttribute("logginStatus") != null){
                ...
                */
                ...
                if(logginStatus == false){
                    ...
                    response.sendRedirect("TopicPage.jsp?topic=" + topic);
                }
            }
...
%>           
                                        <div class="media">
                                            <div class="media-left"></div>
                                            <div class="media-body">
                                                <div class="content" style="margin-left:30px"><strong><%=replies[j][1]%></strong><%=" " + replies[j][0]%></div>
                                            </div>
                                            <br/>
